...
ROLES = {
    ...
    A: The main topic of my report is [User's main topic]
    Then conitnue to English language to ask questions.

    2. EXAMPLE:
    Q: What's the main topic of your report?
    A: yapay zeka ve tıp
    Then continue to Turkish language to ask questions.
